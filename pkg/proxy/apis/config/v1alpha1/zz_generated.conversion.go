...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.KubeProxyInstanceConfiguration)(nil), (*config.KubeProxyInstanceConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_KubeProxyInstanceConfiguration_To_config_KubeProxyInstanceConfiguration(a.(*v1alpha1.KubeProxyInstanceConfiguration), b.(*config.KubeProxyInstanceConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.KubeProxyInstanceConfiguration)(nil), (*v1alpha1.KubeProxyInstanceConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_KubeProxyInstanceConfiguration_To_v1alpha1_KubeProxyInstanceConfiguration(a.(*config.KubeProxyInstanceConfiguration), b.(*v1alpha1.KubeProxyInstanceConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_KubeProxyInstanceConfiguration_To_config_KubeProxyInstanceConfiguration(in *v1alpha1.KubeProxyInstanceConfiguration, out *config.KubeProxyInstanceConfiguration, s conversion.Scope) error {
	out.BindAddress = in.BindAddress
	out.HostnameOverride = in.HostnameOverride
	return nil
}

// Convert_v1alpha1_KubeProxyInstanceConfiguration_To_config_KubeProxyInstanceConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_KubeProxyInstanceConfiguration_To_config_KubeProxyInstanceConfiguration(in *v1alpha1.KubeProxyInstanceConfiguration, out *config.KubeProxyInstanceConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubeProxyInstanceConfiguration_To_config_KubeProxyInstanceConfiguration(in, out, s)
}

func autoConvert_config_KubeProxyInstanceConfiguration_To_v1alpha1_KubeProxyInstanceConfiguration(in *config.KubeProxyInstanceConfiguration, out *v1alpha1.KubeProxyInstanceConfiguration, s conversion.Scope) error {
	out.BindAddress = in.BindAddress
	out.HostnameOverride = in.HostnameOverride
	return nil
}

// Convert_config_KubeProxyInstanceConfiguration_To_v1alpha1_KubeProxyInstanceConfiguration is an autogenerated conversion function.
func Convert_config_KubeProxyInstanceConfiguration_To_v1alpha1_KubeProxyInstanceConfiguration(in *config.KubeProxyInstanceConfiguration, out *v1alpha1.KubeProxyInstanceConfiguration, s conversion.Scope) error {
	return autoConvert_config_KubeProxyInstanceConfiguration_To_v1alpha1_KubeProxyInstanceConfiguration(in, out, s)
}
