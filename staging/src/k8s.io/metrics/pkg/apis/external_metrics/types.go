...
// ExternalMetricValueList represents a list of values for a given metric for some set labels.
...
// ExternalMetricValue represents a metric value for external a metric.
